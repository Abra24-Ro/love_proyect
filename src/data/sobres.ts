...
export const SOBRES: SobreInfo[] = [
  { id: 'frasco', etiqueta: 'Para nosotros', emblema: PROVISIONAL, tema: DURAZNO, x: -96, y: -145, giro: -9, escala: 0.95, salida: 0, z: 1 },
  { id: 'recuerdos', etiqueta: 'Para ti', emblema: LOVE, tema: ORO, x: 0, y: -205, giro: 0, escala: 1.3, salida: 2, z: 3 },
  { id: 'galaxia', etiqueta: 'Para siempre', emblema: FLOWER, tema: LILA, x: 96, y: -145, giro: 9, escala: 0.95, salida: 1, z: 2 },
]